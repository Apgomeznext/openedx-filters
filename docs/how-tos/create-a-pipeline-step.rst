...
In our example, we will configure the pipeline for the :py:class:`openedx_filters.learning.CourseEnrollmentStarted` to include the pipeline step we created. The configuration should look like this:
